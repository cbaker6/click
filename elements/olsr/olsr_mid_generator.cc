...
OLSRMIDGenerator::configure(Vector<String> &conf, ErrorHandler *errh)
{
  int res = cp_va_kparse(conf, this, errh,
			"MID_SENDING_INTERVAL", cpkP+cpkM, cpInteger, &_period,
			"MID_HOLDING_TIME", cpkP+cpkM, cpInteger, &_mid_hold_time,
			"LOCAL_INTERFACE_INFO_BASE", cpkP+cpkM, cpElement, &_localIfInfoBase,
			cpEnd);
